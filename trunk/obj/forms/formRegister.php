...
class formRegister1 extends form {

    // constructor
    function formRegister1($name, $login) {
      ...
      $this->addElement('textarea', 'agb', $lang->getMsg('register_agb'), array("onfocus"=>"this.rows=10", "style"=>"width: 100%; text-align: left;", "readonly"=>"readonly", 'rows' => 5, 'cols' => 80));

      $this->setDefaults(array(
          'agb' => $lang->getMsg('register_agb_text')
      ));
      ...
      $this->addElement('submit', 'submit1', $lang->getMsg('register_submit1'));
...
class formRegister2 extends form {
