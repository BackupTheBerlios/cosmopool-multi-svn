...
class formSearch extends form {
    ...
    function formSearch($name) {
      ...
      $pools_chose = array();
      $pools_chose[] = HTML_QuickForm::createElement('radio', null, null, $lang->getMsg('search_form_where_inmine'), 0);
      $pools_chose[] = HTML_QuickForm::createElement('radio', null, null, $lang->getMsg('search_form_where_pooltoo'), 1);
      ...
      $this->addGroup($pools_chose, 'searchwhere', $lang->getMsg('search_form_where'), '<br>');
